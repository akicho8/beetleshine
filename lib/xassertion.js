...
var Xassertion = {
  ...
  assert_not_null: function assert_not_null(value) {
    var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Assertion failed: null";
    this.assert(value != null, message);
  },
  assert_null: function assert_null(value) {
    var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Assertion failed: not null";
    this.assert(value == null, message);
  },
