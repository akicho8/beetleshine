...
var Xarray = {
  ...
  ary_find_index: function ary_find_index(ary, block) {
    _xassertion.Xassertion.assert_kind_of_array(ary);
    var index = ary.findIndex(function (e) {
      return block(e);
    });
    if (index >= 0) {
      return index;
  ...
  ary_minus: function ary_minus(a, b) {
    _xassertion.Xassertion.assert_kind_of_array(a);
    _xassertion.Xassertion.assert_kind_of_array(b);
    var set_b = new Set(b);
    return a.filter(function (e) {
      return !set_b.has(e);
    });
  },
  ary_any_p: function ary_any_p(ary) {
    var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
      return e;
    };
    return ary.some(function (e) {
      return _xobject.Xobject.truthy_p(block(e));
    });
  },
  ary_all_p: function ary_all_p(ary) {
    var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
      return e;
    };
    return ary.every(function (e) {
      return _xobject.Xobject.truthy_p(block(e));
    });
  },
  ary_none_p: function ary_none_p(ary) {
    var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
      return e;
    };
    return !this.ary_any_p(ary, block);
  },
  ary_one_p: function ary_one_p(ary) {
    var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
      return e;
    };
    return this.ary_find_all(ary, block).length === 1;
  },
  ary_tally: function ary_tally(ary) {
    _xassertion.Xassertion.assert_kind_of_array(ary);
    var count = {};
    ary.forEach(function (e) {
      var _count$e;
      count[e] = ((_count$e = count[e]) !== null && _count$e !== void 0 ? _count$e : 0) + 1;
    });
    return count;
  }
};
