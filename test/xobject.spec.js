...
describe("Xobject", () => {
  ...
  test("truthy_p", () => {
    expect(Xobject.truthy_p({})).toEqual(true)
    expect(Xobject.truthy_p([])).toEqual(true)
    expect(Xobject.truthy_p(0)).toEqual(true)
    expect(Xobject.truthy_p("")).toEqual(true)
    expect(Xobject.truthy_p(false)).toEqual(false)
    expect(Xobject.truthy_p(null)).toEqual(false)
    expect(Xobject.truthy_p(undefined)).toEqual(false)
  })
  test("falsy_p", () => {
    expect(Xobject.falsy_p({})).toEqual(false)
    expect(Xobject.falsy_p([])).toEqual(false)
    expect(Xobject.falsy_p(0)).toEqual(false)
    expect(Xobject.falsy_p("")).toEqual(false)
    expect(Xobject.falsy_p(false)).toEqual(true)
    expect(Xobject.falsy_p(null)).toEqual(true)
    expect(Xobject.falsy_p(undefined)).toEqual(true)
  })
  test("p", () => {
